...
const glowVariants = {
  ...
  tap: {scale: 0.5, y: 0, transition: {duration: 0.8}}
}


const Home = () => {
  const roles = useMemo(() => ['Web Developer', 'MERN Stack Developer', 'Frontend Developer', 'React Developer', 'Software Developer', 'Fullstack Developer'], [])
        ...
        <div className='flex flex-col justify-center text-center lg:text-left relative'>
          <div className='w-full lg:pr-24 mx-auto max-w-3xl'>
            ...
            >
              ...
              <span className='inline-block w-0.5 bg-white animate-pulse align-middle'
               style={{height: '1em'}} 
              ></span>
            </motion.div>
            <motion.h1 className='text-4xl sm:text-5xl lg:text-7xl text-transparent bg-clip-text
            bg-linear-to-r  from-[#302b63] via-[#00bf8f] to-[#1cd8d2] drop-shadow-lg'
            ...
            >
              <a 
                className='px-6 py-3 rounded-full font-medium text-lg text-white bg-linear-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
              ...
              <a
                href='/Vikas_Pimpale_SDE_II.pdf'
                download
                className='px-6 py-3 rounded-full text-lg font-medium text-black bg-white lg:bg-gray-200 
                shadow-lg hover:scale-105 transition-all'
              >
                My Resume
              </a>
